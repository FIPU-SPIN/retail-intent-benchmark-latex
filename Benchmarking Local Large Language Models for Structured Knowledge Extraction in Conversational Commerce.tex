...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{figures/quality_json_validity_by_regime.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{figures/prompt_tokens_by_regime.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{figures/output_tokens_by_regime.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{figures/cost_gpu_power__w_by_regime.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{figures/quality_cost_tradeoff.pdf}
